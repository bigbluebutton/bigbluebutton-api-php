...
class TestCase extends \PHPUnit\Framework\TestCase
{
    ...
    protected function generateCreateParams(): array
    {
        return [
            ...
            'guestPolicy'                            => $this->faker->randomElement(GuestPolicy::cases()),
            ...
            'meetingLayout'                          => $this->faker->randomElement(MeetingLayout::cases()),
            ...
            'disabledFeatures'                       => $this->faker->randomElements(Feature::cases()),
            'disabledFeaturesExclude'                => $this->faker->randomElements(Feature::cases()),
