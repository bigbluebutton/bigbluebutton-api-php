...
class BigBlueButtonTest extends TestCase
{
    ...
    public function testCreateMeetingWithDocumentEmbedded(): void
    {
        ...
        $params->addPresentation('bbb_logo.png', (string) file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'fixtures' . DIRECTORY_SEPARATOR . 'bbb_logo.png'));
    ...
    public function testCreateMeetingWithMultiDocument(): void
    {
        ...
        $params->addPresentation('logo.png', (string) file_get_contents(__DIR__ . DIRECTORY_SEPARATOR . 'fixtures' . DIRECTORY_SEPARATOR . 'bbb_logo.png'));
